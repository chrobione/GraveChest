--this file is to handle multiple storage types as shown by gallery plugin
-- Orginally from Storage.lua
...
--- The DB connection that provides the Chest information
g_DB = nil;
